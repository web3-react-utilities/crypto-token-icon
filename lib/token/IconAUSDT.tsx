...
export const IconAUSDT: SvgComponent = (props) => {
    return (
        ...
        >
            ...
            <path className="cls-3" d="M111.93,187.85a85.24,85.24,0,0,0,75.92-75.92H177.31a73.73,73.73,0,0,1-65.38,66.25Z" />
            <path className="cls-3" d="M18.54,111.93a85.26,85.26,0,0,0,75.92,75.92v-9.67a73.84,73.84,0,0,1-65.38-66.25Z" />
            <path className="cls-3" d="M187.85,94.46a85.26,85.26,0,0,0-75.92-75.92v9.67a73.84,73.84,0,0,1,65.38,66.25Z" />
            <path className="cls-3" d="M94.46,18.54A85.26,85.26,0,0,0,18.54,94.46H29.08A73.74,73.74,0,0,1,94.46,28.21Z" />
            <path
                className="cls-3"
