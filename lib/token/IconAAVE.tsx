...
export const IconAAVE: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} version="1.1" x="0px" y="0px" viewBox="0 0 800 800" xmlSpace="preserve">
            <g>
                <defs>
                    <rect width="800" height="800" />
                </defs>
                <clipPath>
                    <use xlinkHref="#SVGID_1_" style={{ overflow: 'hidden' }} />
                </clipPath>
                <g id="b" clipPath="url(#SVGID_2_)">
                    <linearGradient gradientUnits="userSpaceOnUse" x1="-597.3553" y1="900.6861" x2="-598.0993" y2="900.0601" gradientTransform="matrix(776 0 0 -776 464237 699089)">
                        <stop offset="0" stopColor="#B6509E" />
                        <stop offset="1" stopColor="#2EBAC6" />
                    </linearGradient>
                    <circle fill="url(#SVGID_3_)" cx="400" cy="400" r="388" />
                    <path
                        fill="#FFFFFF"
