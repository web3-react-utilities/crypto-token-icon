...
export const IconWBTC: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} viewBox="0 0 109.26 109.26">
            <g>
                <g>
                    <g>
                        <g>
                            <path style={{ fill: '#5a5564' }} d="M89.09,22.93l-3,3a42.47,42.47,0,0,1,0,57.32l3,3a46.76,46.76,0,0,0,0-63.39Z" />
                            <path style={{ fill: '#5a5564' }} d="M26,23.19a42.47,42.47,0,0,1,57.32,0l3-3a46.76,46.76,0,0,0-63.39,0Z" />
                            <path style={{ fill: '#5a5564' }} d="M23.19,83.28a42.47,42.47,0,0,1,0-57.29l-3-3a46.76,46.76,0,0,0,0,63.39Z" />
                            <path style={{ fill: '#5a5564' }} d="M83.28,86.05a42.47,42.47,0,0,1-57.32,0l-3,3a46.76,46.76,0,0,0,63.39,0Z" />
                            <path
                                style={{ fill: '#f09242' }}
