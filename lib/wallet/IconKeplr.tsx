...
export const IconKeplr: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} viewBox="0 0 42 42" fill="none">
            <g clip-path="url(#clip0_425_5107-keplr)">
                <path
                    ...
                    fill="url(#paint0_linear_425_5107-keplr)"
                />
                <path
                    d="M32.4545 0H9.54545C4.27365 0 0 4.27365 0 9.54545V32.4545C0 37.7264 4.27365 42 9.54545 42H32.4545C37.7264 42 42 37.7264 42 32.4545V9.54545C42 4.27365 37.7264 0 32.4545 0Z"
                    fill="url(#paint1_radial_425_5107-keplr)"
                />
                <path
                    d="M32.4545 0H9.54545C4.27365 0 0 4.27365 0 9.54545V32.4545C0 37.7264 4.27365 42 9.54545 42H32.4545C37.7264 42 42 37.7264 42 32.4545V9.54545C42 4.27365 37.7264 0 32.4545 0Z"
                    fill="url(#paint2_radial_425_5107-keplr)"
                />
                <path
                    d="M32.4545 0H9.54545C4.27365 0 0 4.27365 0 9.54545V32.4545C0 37.7264 4.27365 42 9.54545 42H32.4545C37.7264 42 42 37.7264 42 32.4545V9.54545C42 4.27365 37.7264 0 32.4545 0Z"
                    fill="url(#paint3_radial_425_5107-keplr)"
                />
            ...
            <defs>
                <linearGradient id="paint0_linear_425_5107-keplr" x1="21" y1="0" x2="21" y2="42" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#1FD1FF" />
                    <stop offset="1" stop-color="#1BB8FF" />
                </linearGradient>
                <radialGradient
                    id="paint1_radial_425_5107-keplr"
                    cx="0"
                    cy="0"
                    r="1"
                ...
                <radialGradient
                    id="paint2_radial_425_5107-keplr"
                    cx="0"
                    cy="0"
                    r="1"
                    gradientUnits="userSpaceOnUse"
                ...
                <radialGradient id="paint3_radial_425_5107-keplr" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(20.6501 0.311498) rotate(90) scale(33.1135 80.3423)">
                    <stop stop-color="#24D5FF" />
                    <stop offset="1" stop-color="#1BB8FF" stop-opacity="0" />
                </radialGradient>
                <clipPath id="clip0_425_5107-keplr">
