...
export const IconWalletConnect: SvgComponent = (props) => {
    return (
        <MuiSvgIcon {...props} viewBox="0 0 512 512" fill="none">
            <g clip-path="url(#clip0_5448_12656_WC)">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0Z"
                    fill="url(#paint0_radial_5448_12656_WC)"
                />
                <path
